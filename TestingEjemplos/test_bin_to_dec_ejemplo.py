...
class TestBinaryToDecimal(unittest.TestCase):
    ...
    def test_binario_decimal_con_entradas_validas(self):
        ...
        for d in range(100):
            ...
            binary = binary[2:]  # Eliminamos el prefijo '0b'
            dec_output = bin_to_dec_ejemplo.decimal(binary)
        ...
        #Test con strings
        test_bin_str = ['1010', '1111', '0001', '1', '11111111', '0']
        expected_dec = [10, 15, 1, 1, 255, 0]

        for binary_input, expected_dec_output in zip(test_bin_str, expected_dec):
            dec = bin_to_dec_ejemplo.decimal(binary_input)
    ...
    def test_binario_decimal_con_entradas_invalidas(self):
        ...
        for invalid_input in invalid:
            with self.assertRaises(ValueError):
                bin_to_dec_ejemplo.decimal(invalid_input)
